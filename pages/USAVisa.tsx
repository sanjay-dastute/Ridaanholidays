    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="hidden sm:flex text-sm text-slate-400 gap-2">
          ...
          <span>/</span>
          <span className="text-slate-900 font-bold">USA</span>
        </div>
      </div>
      ...
      <div className="relative h-[350px] sm:h-[400px] md:h-[500px] rounded-2xl sm:rounded-3xl overflow-hidden mb-8 sm:mb-12 group shadow-2xl">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url("/images/statue-of-liberty.jpeg")' }}></div>
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-8 md:p-10 card-shadow">
              <ul className="space-y-8">
                <li className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Full application & document guidance</h3>
                    <p className="text-slate-500 mt-2 text-base leading-relaxed">DS-160 form filling and appointment scheduling handled by our experts.</p>
                  </div>
                </li>
                <li className="flex items-start gap-5">
                  <div className="bg-primary/10 p-2.5 rounded-xl mt-1">
                    <span className="material-symbols-outlined text-primary text-2xl font-bold block">record_voice_over</span>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Personal one-to-one interview preparation</h3>
                    <p className="text-slate-500 mt-2 text-base leading-relaxed">Mock interviews to build your confidence and ensure you're fully prepared.</p>
                  </div>
                </li>
                <li className="flex items-start gap-5">
                  <div className="bg-primary/10 p-2.5 rounded-xl mt-1">
                    <span className="material-symbols-outlined text-primary text-2xl font-bold block">support_agent</span>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Support until embassy interview</h3>
                    <p className="text-slate-500 mt-2 text-base leading-relaxed">We are with you until the day of your appointment and beyond.</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="group relative overflow-hidden rounded-3xl aspect-[16/10] md:col-span-2 cursor-pointer shadow-xl">
                <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" style={{ backgroundImage: 'url("/images/times-square-nyc.png")' }}></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent"></div>
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="font-brand text-white text-3xl mb-3">Times Square, NYC</h3>
                  <p className="text-slate-200 text-sm max-w-lg leading-relaxed">The bright lights of Broadway and the heart of Manhattan. Experience the city that never sleeps.</p>
                </div>
              </div>
              <div className="group relative overflow-hidden rounded-3xl aspect-square cursor-pointer shadow-xl">
                <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" style={{ backgroundImage: 'url("/images/statue-liberty-hd.png")' }}></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent"></div>
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="font-brand text-white text-2xl mb-2">Statue of Liberty</h3>
                  <p className="text-slate-200 text-xs leading-relaxed opacity-90">A universal symbol of freedom and democracy on Liberty Island.</p>
                </div>
              </div>
              <div className="group relative overflow-hidden rounded-3xl aspect-square cursor-pointer shadow-xl">
                <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" style={{ backgroundImage: 'url("/images/nyc-skyline.png")' }}></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent"></div>
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="font-brand text-white text-2xl mb-2">NYC Nightlife</h3>
                  <p className="text-slate-200 text-xs leading-relaxed opacity-90">Experience the electric energy of New York after dark.</p>
                </div>
              </div>
            </div>
          </section>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-28 space-y-6">
            ...
            <div className="bg-red-50 border-2 border-red-100 rounded-2xl p-6 flex items-start gap-5">
              <div className="w-10 h-10 rounded-full bg-red-500 flex-shrink-0 flex items-center justify-center text-white shadow-md">
                <span className="material-symbols-outlined text-[20px]">warning</span>
              </div>
              <div>
                <h4 className="text-base font-bold text-slate-900 mb-1">High Demand</h4>
                <p className="text-sm text-slate-600 leading-relaxed font-medium">
                  USA visa appointment wait times can be long. We recommend applying at least 3-4 months before travel.
                </p>
              </div>
            </div>
