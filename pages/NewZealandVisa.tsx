        ...
        <div className="absolute bottom-0 left-0 p-4 sm:p-6 md:p-12 text-white w-full">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6 md:gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-200 font-medium max-w-xl hidden sm:block">Discover Middle-earth with ease. Simple, fully online processing for your New Zealand adventure.</p>
            </div>
