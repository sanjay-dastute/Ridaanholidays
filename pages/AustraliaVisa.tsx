    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="hidden sm:flex text-sm text-slate-400 gap-2">
          ...
          <span>/</span>
          <span className="text-slate-900 font-bold">Australia</span>
        </div>
      </div>
      ...
      <div className="relative h-[350px] sm:h-[400px] md:h-[500px] rounded-2xl sm:rounded-3xl overflow-hidden mb-8 sm:mb-12 group shadow-2xl">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?auto=format&fit=crop&q=80&w=2000")' }}></div>
        ...
        <div className="absolute bottom-0 left-0 p-4 sm:p-6 md:p-12 text-white w-full">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6 md:gap-8">
            <div className="max-w-2xl">
              ...
              <h1 className="font-brand text-3xl sm:text-4xl md:text-5xl lg:text-7xl mb-2 sm:mb-4 text-white">Australia Visitor Visa</h1>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-200 font-medium max-w-xl hidden sm:block">Visit the land down under with our seamless eVisa service. Sun, surf, and cities await.</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-8 md:p-10 card-shadow">
              <ul className="space-y-8">
                <li className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Simple digital visa application</h3>
                    <p className="text-slate-500 mt-2 text-base leading-relaxed">We manage the online portal on your behalf for a stress-free experience.</p>
                  </div>
                </li>
                <li className="flex items-start gap-5">
                  <div className="bg-primary/10 p-2.5 rounded-xl mt-1">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Passport stays with you</h3>
                    <p className="text-slate-500 mt-2 text-base leading-relaxed">No need to mail your original documents. Your visa is electronically linked.</p>
                  </div>
                </li>
                <li className="flex items-start gap-5">
                  <div className="bg-primary/10 p-2.5 rounded-xl mt-1">
                    <span className="material-symbols-outlined text-primary text-2xl font-bold block">rocket_launch</span>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Smooth and hassle-free process</h3>
                    <p className="text-slate-500 mt-2 text-base leading-relaxed">Expert handling to ensure quick approval with minimal effort from you.</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  { icon: 'info', text: 'Visitor Visa (Subclass 600)' },
                  { icon: 'laptop_mac', text: 'Fully digital eVisa' },
                  { icon: 'block', text: 'No work or study permitted' },
                  { icon: 'admin_panel_settings', text: 'Australian decision is final' }
                ].map((item, idx) => (
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="group relative overflow-hidden rounded-3xl aspect-[16/10] md:col-span-2 cursor-pointer shadow-xl">
                <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" style={{ backgroundImage: 'url("/images/great-barrier-reef.png")' }}></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent"></div>
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="font-brand text-white text-3xl mb-3">Great Barrier Reef</h3>
                  <p className="text-slate-200 text-sm max-w-lg leading-relaxed">World's largest coral reef system, a UNESCO World Heritage Site with breathtaking marine life.</p>
                </div>
              </div>
              <div className="group relative overflow-hidden rounded-3xl aspect-square cursor-pointer shadow-xl">
                <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" style={{ backgroundImage: 'url("/images/uluru.png")' }}></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent"></div>
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="font-brand text-white text-2xl mb-2">Uluru</h3>
                  <p className="text-slate-200 text-xs leading-relaxed opacity-90">Sacred sandstone monolith in the heart of the Australian Outback.</p>
                </div>
              </div>
              <div className="group relative overflow-hidden rounded-3xl aspect-square cursor-pointer shadow-xl">
                <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" style={{ backgroundImage: 'url("/images/melbourne.png")' }}></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent"></div>
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="font-brand text-white text-2xl mb-2">Melbourne</h3>
                  <p className="text-slate-200 text-xs leading-relaxed opacity-90">Cultural capital with amazing coffee, street art, and vibrant food scene.</p>
                </div>
              </div>
            </div>
          </section>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-28 space-y-6">
            ...
            <div className="bg-yellow-50 border-2 border-yellow-100 rounded-2xl p-6 flex items-start gap-5">
              <div className="w-10 h-10 rounded-full bg-yellow-500 flex-shrink-0 flex items-center justify-center text-white shadow-md">
                <span className="material-symbols-outlined text-[20px]">lightbulb</span>
              </div>
              <div>
                <h4 className="text-base font-bold text-slate-900 mb-1">Did you know?</h4>
                <p className="text-sm text-slate-600 leading-relaxed font-medium">
                  Australia's visa system is almost entirely digital. Your visa is electronically linked to your passport.
                </p>
              </div>
            </div>
