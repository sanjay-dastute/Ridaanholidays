    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <div className="hidden sm:flex text-sm text-slate-400 gap-2">
          ...
          <span>/</span>
          <span className="text-slate-900 font-bold">United Kingdom</span>
        </div>
      </div>
      ...
      <div className="relative h-[350px] sm:h-[400px] md:h-[500px] rounded-2xl sm:rounded-3xl overflow-hidden mb-8 sm:mb-12 group shadow-2xl">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&q=80&w=2000")' }}></div>
        ...
        <div className="absolute bottom-0 left-0 p-4 sm:p-6 md:p-12 text-white w-full">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="bg-white text-slate-900 px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 rounded-xl sm:rounded-2xl shadow-[0_20px_50px_rgba(228,30,38,0.3)] w-full sm:w-auto sm:min-w-[200px] md:min-w-[240px] border-b-4 border-primary">
              ...
              <p className="text-2xl sm:text-3xl md:text-4xl font-black text-primary">£270 <span className="text-xs sm:text-sm font-bold text-slate-400 inline">All Included</span></p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-8 md:p-10 card-shadow">
              <ul className="space-y-8">
                <li className="flex items-start gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">UK-based support you can trust</h3>
                    <p className="text-slate-500 mt-2 text-base leading-relaxed">Expert knowledge of current UK immigration rules and requirements.</p>
                  </div>
                </li>
                <li className="flex items-start gap-5">
                  <div className="bg-primary/10 p-2.5 rounded-xl mt-1">
                    <span className="material-symbols-outlined text-primary text-2xl font-bold block">edit_document</span>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Full application & document assistance</h3>
                    <p className="text-slate-500 mt-2 text-base leading-relaxed">We review every detail to ensure compliance with UKVI requirements.</p>
                  </div>
                </li>
                <li className="flex items-start gap-5">
                  <div className="bg-primary/10 p-2.5 rounded-xl mt-1">
                    <span className="material-symbols-outlined text-primary text-2xl font-bold block">route</span>
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-slate-900">Clear step-by-step guidance</h3>
                    <p className="text-slate-500 mt-2 text-base leading-relaxed">Know exactly what to provide and when. No confusion, no delays.</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  { icon: 'info', text: 'Standard Visitor Visa' },
                  { icon: 'calendar_month', text: 'Stay up to 6 months' },
                  { icon: 'fingerprint', text: 'Biometric appointment required' },
                  { icon: 'admin_panel_settings', text: 'UKVI decision is final' }
                ].map((item, idx) => (
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="group relative overflow-hidden rounded-3xl aspect-[16/10] md:col-span-2 cursor-pointer shadow-xl">
                <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" style={{ backgroundImage: 'url("/images/london-eye.png")' }}></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent"></div>
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="font-brand text-white text-3xl mb-3">London Eye</h3>
                  <p className="text-slate-200 text-sm max-w-lg leading-relaxed">Iconic riverside observation wheel offering stunning panoramic views of the city skyline.</p>
                </div>
              </div>
              <div className="group relative overflow-hidden rounded-3xl aspect-square cursor-pointer shadow-xl">
                <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" style={{ backgroundImage: 'url("/images/stonehenge.png")' }}></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent"></div>
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="font-brand text-white text-2xl mb-2">Stonehenge</h3>
                  <p className="text-slate-200 text-xs leading-relaxed opacity-90">Prehistoric monument and UNESCO World Heritage Site in Wiltshire.</p>
                </div>
              </div>
              <div className="group relative overflow-hidden rounded-3xl aspect-square cursor-pointer shadow-xl">
                <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-110" style={{ backgroundImage: 'url("/images/scottish-highlands.png")' }}></div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent"></div>
                <div className="absolute bottom-0 left-0 p-8">
                  <h3 className="font-brand text-white text-2xl mb-2">Scottish Highlands</h3>
                  <p className="text-slate-200 text-xs leading-relaxed opacity-90">Dramatic mountains, mysterious lochs, and breathtaking landscapes.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <div className="sticky top-28 space-y-6">
            <div className="bg-white border-2 border-primary rounded-3xl p-8 card-shadow overflow-hidden relative">
              ...
              <div className="flex items-baseline gap-2 mb-8 relative z-10">
                <span className="text-5xl font-black text-primary">£270</span>
            ...
            <div className="bg-blue-50 border-2 border-blue-100 rounded-2xl p-6 flex items-start gap-5">
              <div className="w-10 h-10 rounded-full bg-blue-500 flex-shrink-0 flex items-center justify-center text-white shadow-md">
                <span className="material-symbols-outlined text-[20px]">info</span>
              </div>
              <div>
                <h4 className="text-base font-bold text-slate-900 mb-1">Good to Know</h4>
                <p className="text-sm text-slate-600 leading-relaxed font-medium">
                  The UK Standard Visitor visa allows you to visit for tourism, business meetings, or seeing family.
                </p>
              </div>
            </div>
